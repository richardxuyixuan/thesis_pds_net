...
class SalsaNextCompletionSingleDecoderStageTwoEndToEnd(nn.Module):
    def __init__(self, nclasses):
        super(SalsaNextCompletionSingleDecoderStageTwoEndToEnd, self).__init__()
    ...
    def forward(self, x, proj_mask):
        ...
        return logits_s, completed_scene